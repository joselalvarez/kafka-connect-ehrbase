...
public class EHRBaseChangeMapper {
    ...
    public CompositionChange mapCompositionChange(EHRBaseChange source) {
        ...
        target.setContributionId(source.getContributionId());
        ...
        try {
            Composition composition = EHRBaseSdkFacade.reconstructRmObject(Composition.class, new String(source.getAggregate()));
    ...
    public EhrStatusChange mapEhrStatusChange(EHRBaseChange source) {
        ...
        try {
            EhrStatus status = EHRBaseSdkFacade.reconstructRmObject(EhrStatus.class, new String(source.getAggregate()));
